...
Fewer plants survived over winter in the North garden than in the South garden (`r survival_north`% versus `r survival_south`%). In both gardens, southern source populations survived more often than northern source populations even after accounting for block effects (Fig. \ref{fig:mean-traits}b). For example, in the North garden, we estimated that plants originating from the most southern source population, Sweetwater River, survived `r p_CUR_north` of the time compared to `r p_RCK_north` for the most northern source population Rock Creek. Similarly, in the South garden the local population from Sweetwater River survived `r p_CUR_south` of the time compared to `r p_RCK_south` for Rock Creek. For most populations, the average temperature was warmer than the historical normal from $1961 \textendash 1990$, especially for the winter season in the South garden (Fig. \ref{fig:climate}). However, temperatures for the North garden were close to their historical norm.
...
## Directional selection favors faster germination between but not within populations
