...
Data are available on Dryad [URL TBA]. Source code for all analyses is archived on Zenodo [URL TBA]. A repository with data and code is available on GitHub [https://github.com/cdmuir/mimulus-germination](https://github.com/cdmuir/mimulus-germination).
